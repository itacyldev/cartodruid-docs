...
canonical: https://docs.cartodruid.es/es/latest/symbology/simbologias/
extra:
  hreflang:
    - lang: en
      url: https://docs.cartodruid.es/es/latest/symbology/simbologias/
    - lang: es
      url: https://docs.cartodruid.es/es/latest/symbology/simbologias.es/
---
